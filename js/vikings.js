...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Minnesota Vikings Draft History by AV")
    .classed("vikings_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("vikings_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("vikings_active", true)
            .classed("vikings_inactive", false);
          Rookie_AV
            .classed("vikings_active", false)
            .classed("vikings_inactive", true);
        }
        else {
          Career_AV
