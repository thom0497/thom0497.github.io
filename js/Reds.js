...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Cincinnati Reds") {
      return d;
    }
  })
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Cincinnati Reds Draft History by WAR")
    .classed("reds_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("reds_active", true)
            .classed("reds_inactive", false);
          TC_WAR
            .classed("reds_active", false)
            .classed("reds_inactive", true);
        }
        else {
          Career_WAR
