    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("texans_active", true)
            .classed("texans_inactive", false);
          Rookie_AV
            .classed("texans_active", false)
            .classed("texans_inactive", true);
        }
        else {
          Career_AV
