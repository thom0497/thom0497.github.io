...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Denver Broncos Draft History by AV")
    .classed("broncos_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("broncos_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("broncos_active", true)
            .classed("broncos_inactive", false);
          Rookie_AV
            .classed("broncos_active", false)
            .classed("broncos_inactive", true);
        }
        else {
          Career_AV
