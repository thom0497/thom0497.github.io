...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Team"] == "Jacksonville Jaguars") {
      return d;
    }
  })
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Jacksonville Jaguars Draft History by AV")
    .classed("jaguars_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("jaguars_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("jaguars_active", true)
            .classed("jaguars_inactive", false);
          Rookie_AV
            .classed("jaguars_active", false)
            .classed("jaguars_inactive", true);
        }
        else {
          Career_AV
