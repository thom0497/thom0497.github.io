...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("steelers_inactive", true)
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Pittsburgh Steelers Draft History by AV")
    .classed("steelers_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("steelers_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("steelers_active", true)
            .classed("steelers_inactive", false);
          Rookie_AV
            .classed("steelers_active", false)
            .classed("steelers_inactive", true);
        }
        else {
          Career_AV
