...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("New York Jets Draft History by AV")
    .classed("jets_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("jets_active", true)
            .classed("jets_inactive", false);
          Rookie_AV
            .classed("jets_active", false)
            .classed("jets_inactive", true);
        }
        else {
          Career_AV
