...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("New Orleans Saints Draft History by AV")
    .classed("saints_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("saints_active", true)
            .classed("saints_inactive", false);
          Rookie_AV
            .classed("saints_active", false)
            .classed("saints_inactive", true);
        }
        else {
          Career_AV
