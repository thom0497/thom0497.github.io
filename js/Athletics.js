...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Oakland Athletics") {
      return d;
    }
  })
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("athletics_inactive", true)
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Oakland Athletics Draft History by WAR")
    .classed("athletics_title", true)
  ;
  ...
  var TC_WAR = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("athletics_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("athletics_active", true)
            .classed("athletics_inactive", false);
          TC_WAR
            .classed("athletics_active", false)
            .classed("athletics_inactive", true);
        }
        else {
          Career_WAR
