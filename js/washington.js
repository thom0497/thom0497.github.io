...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("washington_inactive", true)
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Washington Team Draft History by AV")
    .classed("washington_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("washington_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("washington_active", true)
            .classed("washington_inactive", false);
          Rookie_AV
            .classed("washington_active", false)
            .classed("washington_inactive", true);
        }
        else {
          Career_AV
