...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Chicago Bears Draft History by AV")
    .classed("bears_title", true)
    ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("bears_active", true)
            .classed("bears_inactive", false);
          Rookie_AV
            .classed("bears_active", false)
            .classed("bears_inactive", true);
        }
        else {
          Career_AV
