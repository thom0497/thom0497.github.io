    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("niners_active", true)
            .classed("niners_inactive", false);
          Rookie_AV
            .classed("niners_active", false)
            .classed("niners_inactive", true);
        }
        else {
          Career_AV
