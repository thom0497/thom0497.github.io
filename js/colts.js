...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Indianapolis Colts Draft History by AV")
    .classed("colts_title", true)
    ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("colts_active", true)
            .classed("colts_inactive", false);
          Rookie_AV
            .classed("colts_active", false)
            .classed("colts_inactive", true);
        }
        else {
          Career_AV
