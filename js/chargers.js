...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Team"] == "Los Angeles Chargers") {
      return d;
    }
  })
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("chargers_inactive", true)
  ...
  svg.append("text")
    ...
    .text("Los Angeles Chargers Draft History by AV")
    .classed("chargers_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("chargers_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("chargers_active", true)
            .classed("chargers_inactive", false);
          Rookie_AV
            .classed("chargers_active", false)
            .classed("chargers_inactive", true);
        }
        else {
          Career_AV
