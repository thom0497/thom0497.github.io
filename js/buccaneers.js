...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Team"] == "Tampa Bay Buccaneers") {
      return d;
    }
  })
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("buccaneers_inactive", true)
  ...
  svg.append("text")
    ...
    .text("Tampa Bay Buccaneers Draft History by AV")
    .classed("buccaneers_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("buccaneers_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("buccaneers_active", true)
            .classed("buccaneers_inactive", false);
          Rookie_AV
            .classed("buccaneers_active", false)
            .classed("buccaneers_inactive", true);
        }
        else {
          Career_AV
