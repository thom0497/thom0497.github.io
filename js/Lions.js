...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Detroit Lions Draft History by AV")
    .classed("lions_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("lions_active", true)
            .classed("lions_inactive", false);
          Rookie_AV
            .classed("lions_active", false)
            .classed("lions_inactive", true);
        }
        else {
          Career_AV
