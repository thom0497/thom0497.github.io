...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Baltimore Ravens Draft History by AV")
    .classed("ravens_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("ravens_active", true)
            .classed("ravens_inactive", false);
          Rookie_AV
            .classed("ravens_active", false)
            .classed("ravens_inactive", true);
        }
        else {
          Career_AV
