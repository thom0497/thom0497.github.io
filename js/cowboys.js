...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Dallas Cowboys Draft History by AV")
    .classed("cowboys_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("cowboys_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("cowboys_active", true)
            .classed("cowboys_inactive", false);
          Rookie_AV
            .classed("cowboys_active", false)
            .classed("cowboys_inactive", true);
        }
        else {
          Career_AV
