...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Green Bay Packers Draft History by AV")
    .classed("packers_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("packers_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("packers_active", true)
            .classed("packers_inactive", false);
          Rookie_AV
            .classed("packers_active", false)
            .classed("packers_inactive", true);
        }
        else {
          Career_AV
