...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Seattle Mariners") {
      return d;
    }
  })
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("mariners_inactive", true)
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Seattle Mariners Draft History by WAR")
    .classed("mariners_title", true)
  ;
  ...
  var TC_WAR = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("mariners_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("mariners_active", true)
            .classed("mariners_inactive", false);
          TC_WAR
            .classed("mariners_active", false)
            .classed("mariners_inactive", true);
        }
        else {
          Career_WAR
