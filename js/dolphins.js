...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("dolphins_inactive", true)
  ...
  svg.append("text")
    ...
    .text("Miami Dolphins Draft History by AV")
    .classed("dolphins_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("dolphins_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("dolphins_active", true)
            .classed("dolphins_inactive", false);
          Rookie_AV
            .classed("dolphins_active", false)
            .classed("dolphins_inactive", true);
        }
        else {
          Career_AV
