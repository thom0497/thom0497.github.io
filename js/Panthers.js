...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("panthers_inactive", true)
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Carolina Panthers Draft History by AV")
    .classed("panthers_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("panthers_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("panthers_active", true)
            .classed("panthers_inactive", false);
          Rookie_AV
            .classed("panthers_active", false)
            .classed("panthers_inactive", true);
        }
        else {
          Career_AV
