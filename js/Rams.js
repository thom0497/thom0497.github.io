...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Los Angeles Rams Draft History by AV")
    .classed("rams_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("rams_active", true)
            .classed("rams_inactive", false);
          Rookie_AV
            .classed("rams_active", false)
            .classed("rams_inactive", true);
        }
        else {
          Career_AV
