...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Las Vegas Raiders Draft History by AV")
    .classed("raiders_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("raiders_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("raiders_active", true)
            .classed("raiders_inactive", false);
          Rookie_AV
            .classed("raiders_active", false)
            .classed("raiders_inactive", true);
        }
        else {
          Career_AV
