...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Atlanta Falcons Draft History by AV")
    .classed("falcons_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("falcons_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("falcons_active", true)
            .classed("falcons_inactive", false);
          Rookie_AV
            .classed("falcons_active", false)
            .classed("falcons_inactive", true);
        }
        else {
          Career_AV
