...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var barGroup = chartGroup.selectAll("rect")
    ...
    .classed("seahawks_inactive", true)
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Seattle Seahawks Draft History by AV")
    .classed("seahawks_title", true)
  ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("seahawks_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("seahawks_active", true)
            .classed("seahawks_inactive", false);
          Rookie_AV
            .classed("seahawks_active", false)
            .classed("seahawks_inactive", true);
        }
        else {
          Career_AV
