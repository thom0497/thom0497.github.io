...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Cincinnati Bengals Draft History by AV")
    .classed("bengals_title", true)
    ;
  ...
  var Rookie_AV = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("bengals_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("bengals_active", true)
            .classed("bengals_inactive", false);
          Rookie_AV
            .classed("bengals_active", false)
            .classed("bengals_inactive", true);
        }
        else {
          Career_AV
