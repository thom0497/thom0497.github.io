...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Houston Astros") {
      return d;
    }
  })
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Houston Astros Draft History by WAR")
    .classed("astros_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("astros_active", true)
            .classed("astros_inactive", false);
          TC_WAR
            .classed("astros_active", false)
            .classed("astros_inactive", true);
        }
        else {
          Career_WAR
