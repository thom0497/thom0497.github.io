...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
    ...
    svg.append("text")
        ...
        .text("Cleveland Browns Draft History by AV")
        .classed("browns_title", true)
        ;
        ...
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                if (chosenYAxis === "CarAV") {
                    Career_AV
                        .classed("browns_active", true)
                        .classed("browns_inactive", false);
                    Rookie_AV
                        .classed("browns_active", false)
                        .classed("browns_inactive", true);
                }
                else {
                    Career_AV
