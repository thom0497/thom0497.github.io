...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Los Angeles Angels") {
      return d;
    }
  })
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Los Angeles Angels Draft History by WAR")
    .classed("angels_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("angels_active", true)
            .classed("angels_inactive", false);
          TC_WAR
            .classed("angels_active", false)
            .classed("angels_inactive", true);
        }
        else {
          Career_WAR
