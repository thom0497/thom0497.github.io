...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Pittsburgh Pirates") {
      return d;
    }
  })
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Pittsburgh Pirates Draft History by WAR")
    .classed("pirates_title", true)
  ;
  ...
  var TC_WAR = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("pirates_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("pirates_active", true)
            .classed("pirates_inactive", false);
          TC_WAR
            .classed("pirates_active", false)
            .classed("pirates_inactive", true);
        }
        else {
          Career_WAR
