...
d3.csv("data/Data_Grouped_by_Year_and_Franchise.csv").then(function (teamData, err) {
  ...
  var FranchiseTeamData = teamData.filter(function (d) {
    if (d["Current_Franchise"] == "Milwaukee Brewers") {
      return d;
    }
  })
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Milwaukee Brewers Draft History by WAR")
    .classed("brewers_title", true)
  ;
  ...
  var TC_WAR = labelsGroup.append("text")
    ...
    .classed("active", true)
    .classed("brewers_axis-text", true)
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "Career_Total_WAR") {
          Career_WAR
            .classed("brewers_active", true)
            .classed("brewers_inactive", false);
          TC_WAR
            .classed("brewers_active", false)
            .classed("brewers_inactive", true);
        }
        else {
          Career_WAR
