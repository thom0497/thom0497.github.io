...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  var labelsGroup = chartGroup.append("g")
    ...
    .text("Tennessee Titans Draft History by AV")
    .classed("titans_title", true)
  ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("titans_active", true)
            .classed("titans_inactive", false);
          Rookie_AV
            .classed("titans_active", false)
            .classed("titans_inactive", true);
        }
        else {
          Career_AV
