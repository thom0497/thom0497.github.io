...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Philadelphia Eagles Draft History by AV")
    .classed("eagles_title", true)
    ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("eagles_active", true)
            .classed("eagles_inactive", false);
          Rookie_AV
            .classed("eagles_active", false)
            .classed("eagles_inactive", true);
        }
        else {
          Career_AV
