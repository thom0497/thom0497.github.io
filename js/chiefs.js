...
d3.csv("Bar_Chart_Data.csv").then(function (teamData, err) {
  ...
  svg.append("text")
    ...
    .text("Kansas City Chiefs Draft History by AV")
    .classed("chiefs_title", true)
    ;
    ...
    .on("click", function () {
      ...
      if (value !== chosenYAxis) {
        ...
        if (chosenYAxis === "CarAV") {
          Career_AV
            .classed("chiefs_active", true)
            .classed("chiefs_inactive", false);
          Rookie_AV
            .classed("chiefs_active", false)
            .classed("chiefs_inactive", true);
        }
        else {
          Career_AV
